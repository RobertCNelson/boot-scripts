...
mii 0 crs		rmii 0 crs/rxdv		spi 1 data 0		i²c 1 sda		asp 1 tx clk		uart 5 cts		uart 2 rxd		gpio 3.01		eth mii crs
mii 0 rxer		rmii 0 rxer		spi 1 data 1		i²c 1 scl		asp 1 tx fs		uart 5 rts		uart 2 txd		gpio 3.02		eth mii rx err
...
spi 0 data 0		uart 2 txd		i²c 2 scl		pwm 0 out B		uart pru rts		pru edio latch		jtag emu 3		gpio 0.03		P9.21 / spi boot in
spi 0 data 1		mmc 1 wp		i²c 1 sda		pwm 0 tripzone		uart pru rxd		pru edio in 0		pru edio out 0		gpio 0.04		P9.18 / spi boot out
...
uart 0 cts		uart 4 rxd		can 1 tx		i²c 1 sda		spi 1 data 0		timer 7			pru edc sync 0 out	gpio 1.08		-×
uart 0 rts		uart 4 txd		can 1 rx		i²c 1 scl		spi 1 data 1		spi 1 cs 0		pru edc sync 1 out	gpio 1.09		-TP9
